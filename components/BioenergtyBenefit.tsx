...
export default function BioenergtyBenefit() {
      ...
      <div className="container">
        <div className="flex-col grid grid-cols-1 gap-8 rounded-2xl border border-border p-4 lg:grid-cols-2 lg:p-8 xl:gap-20">
          <div className="flex flex-col-reverse justify-between gap-8 lg:flex-col">
            ...
            {/* Tab Buttons */}
            <div className="bg-muted text-muted-foreground inline-flex w-fit items-center justify-center mx-auto h-12 rounded-full p-1 lg:mx-0">
              {tabsData.map((tab) => (
                <button
                  key={tab.id}
