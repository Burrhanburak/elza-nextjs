...
export default function AwardFilterDrawer({ onFilter }: AwardFilterDrawerProps) {
  ...
  const handleApplyFilter = () => {
    ...
    const newUrl = `/${locale}/about/awards-achievements${newSearchParams.toString() ? `?${newSearchParams.toString()}` : ''}`;
    router.push(newUrl);
  ...
  const handleClearFilters = () => {
    ...
    setSearchQuery('');
    router.push(`/${locale}/about/awards-achievements`);
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            <DrawerTitle>{t('filterAwards')}</DrawerTitle>
            <DrawerDescription>
              {t('filterAwardsDescription')}
            </DrawerDescription>
          </DrawerHeader>
