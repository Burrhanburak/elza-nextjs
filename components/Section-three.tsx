      ...
      <div className='container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex flex-col gap-6 py-4 lg:py-8'>
          <span data-slot='badge' className='inline-flex items-center justify-center rounded-md border py-0.5 whitespace-nowrap shrink-0 [&>svg]:size-3 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden text-foreground [a&]:hover:bg-accent [a&]:hover:text-accent-foreground w-fit gap-1 bg-card px-3 text-sm font-normal tracking-tight shadow-sm'>
            ...
            <span>Bioenerji ve Bioterapi asamaları</span>
          </span>
          <h2 className='text-3xl leading-tight tracking-tight md:text-4xl lg:text-6xl'>Bioenerji ve Bioterapi asamaları</h2>
          <div className='flex flex-col gap-2'>
            <p className='text-muted-foreground'>Bioenerji ve bioterapi asamaları hakkında bilgi edinin.</p>
            <p className='inline-flex items-center gap-1 text-primary'>
              <span className='underline'>Daha Fazla Bilgi</span>
        ...
        <div className='mt-10 grid gap-8 sm:grid-cols-2 md:mt-14 lg:grid-cols-3'>
          <div className='flex gap-2.5'>
            ...
            <div>
              <h3 className='text-lg leading-none tracking-[-0.96px] lg:text-2xl'>Bioenerji Terapisi</h3>
              <p className='mt-2.5 text-sm tracking-[-0.36px] text-muted-foreground'>Bioenerji terapisi, enerji alanınızı dengeleyerek fiziksel, duygusal ve ruhsal sağlığınızı restore eder.</p>
            </div>
          </div>
          <div className='flex gap-2.5'>
            ...
            <div>
              <h3 className='text-lg leading-none tracking-[-0.96px] lg:text-2xl'>Bioterapi</h3>
                <p className='mt-2.5 text-sm tracking-[-0.36px] text-muted-foreground'>Bioterapi, hücrelerin düzeyinde iyileşme sağlayarak bağışıklık sisteminizi güçlendirir ve doğal iyileşme kapasitezinizi artırır.</p>
              </div>
          </div>
          <div className='flex gap-2.5'>
            ...
            <div>
              <h3 className='text-lg leading-none tracking-[-0.96px] lg:text-2xl'>Sürekli İyileşme ve Gizlilik</h3>
              <p className='mt-2.5 text-sm tracking-[-0.36px] text-muted-foreground'>Sürekli iyileşme, fiziksel, duygusal ve ruhsal sağlığınızı dengelerken entegre bir yaklaşım sunar.</p>
            </div>
          </div>
        </div>
      </div>
